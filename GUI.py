...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        delete_row_button = QPushButton('Delete Process')
        delete_row_button.clicked.connect(self.delete_process)
    ...
    def delete_process(self):
        indices = self.process_table.selectionModel().selectedRows()
